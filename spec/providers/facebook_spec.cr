...
describe MultiAuth::Provider::Facebook do
  it "generates authorize_uri" do
    ...
    uri.should eq("https://www.facebook.com/v24.0/dialog/oauth?client_id=facebook_id&redirect_uri=%2Fcallback&response_type=code&scope=email")
  end
  ...
  it "generates authorize_uri with state query param" do
    ...
    uri.should eq("https://www.facebook.com/v24.0/dialog/oauth?client_id=facebook_id&redirect_uri=%2Fcallback&response_type=code&scope=email&state=random_state_value")
  end

  it "fetch user" do
    WebMock.wrap do
      WebMock
        .stub(:post, "https://graph.facebook.com/v24.0/oauth/access_token")
        .with(
      ...
      WebMock
        .stub(:get, "https://graph.facebook.com/v24.0/me?fields=id,name,last_name,first_name,email,location,about,website")
        .to_return(
          body: %({
              "name" : "Sergey",
              "id" : "3333"
