...
class MultiAuth::Provider::Facebook < MultiAuth::Provider
  ...
  private def fetch_fb_user(code)
    ...
    raw_json = api.get("/v24.0/me?fields=id,name,last_name,first_name,email,location,about,website").body
  ...
  private def client
    OAuth2::Client.new(
      ...
      authorize_uri: "/v24.0/dialog/oauth",
    )
  end
  ...
  private def token_client
    OAuth2::Client.new(
      ...
      secret,
      redirect_uri: redirect_uri,
      token_uri: "/v24.0/oauth/access_token",
